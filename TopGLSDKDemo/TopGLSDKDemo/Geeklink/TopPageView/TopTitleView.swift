...
//MARK:delegate 1
protocol TopTitleViewDelegate:class {//1 NSObjectProtocol 2 class 只能被类遵守
    func titleView(_ titleView :TopTitleView,targetIndex:Int)
}

protocol TopTitleViewPickerDelegate:class {//1 NSObjectProtocol 2 class 只能被类遵守
    func titleView(_ titleView :TopTitleView,targetIndex:Int)
}
...
class TopTitleView: UIView {
    ...
    //MARK:delegate 2
    weak var delegate : TopTitleViewDelegate?
    weak var pickerDelegate : TopTitleViewPickerDelegate?
    ...
    init(frame: CGRect,titles : [String],style : TopPageStyle) {
        self.titles = titles
    ...
    private  func setupLabels(){
        ...
        for (i,titleLabel) in titleLabels.enumerated(){
            if titleStyle.isScrollEnable{
                ...
                let attributes = [NSAttributedString.Key.font : titleStyle.titleFont]
...
extension TopTitleView{
    @objc fileprivate func titleLabelClick(_ tapGes:UITapGestureRecognizer){
        ...
        pickerDelegate?.titleView(self, targetIndex: currentIndex)
        //调整中间位置offset
        adjustLabelPos()
...
//MARK:- 代理的使用 2
extension TopTitleView:TopContentViewDelegate{
    func contentView(_ contentView: TopContentView, didEndScroll inIndex: Int) {
    ...
    func contentView(_ contentView: TopContentView, sourceIndex: Int, targetIndex: Int, progress: CGFloat) {
