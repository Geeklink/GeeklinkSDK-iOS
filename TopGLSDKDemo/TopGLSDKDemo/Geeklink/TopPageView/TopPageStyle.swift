...
class TopPageStyle {
    ...
    var normalColor : UIColor = UIColor.black//正常显示的颜色
    ...
    var bottomLineExtendWidth : CGFloat = (UIScreen.main.bounds.width - 250) * 0.5//下划线的inset
    ...
    var coverAlpha : CGFloat =  1//遮罩的透明，根据需要设置
