...
- (void)geekNormalStyle
{
    [self bootstrapStyle];
//    [self setTitleColor:[GlobarMethod colorFromARGB:geek_NormalBtnColor] forState:UIControlStateNormal];
//    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
//    self.backgroundColor = [UIColor whiteColor];
//    self.layer.borderColor = [[GlobarMethod colorFromARGB:geek_NormalBtnColor] CGColor];
//    [self setBackgroundImage:[self buttonImageFromColor:[GlobarMethod colorFromARGB:geekcolor_tab]] forState:UIControlStateHighlighted];
}

- (void)geekCellStyle
{
    [self bootstrapStyle];
//    [self setTitleColor:[GlobarMethod colorFromARGB:geek_cellDetailTextColor] forState:UIControlStateNormal];
//    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
//    self.backgroundColor = [GlobarMethod colorFromARGB:geek_CellSelectColor];
//    self.layer.borderColor = [[GlobarMethod colorFromARGB:geek_CellSelectColor] CGColor];
//    [self setBackgroundImage:[self buttonImageFromColor:[GlobarMethod colorFromARGB:geek_cellDetailTextColor]] forState:UIControlStateHighlighted];
}
...
- (void)geekClearStyle
{
    [self bootstrapStyle];
//    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    [self setTitleColor:[GlobarMethod colorFromARGB:geek_CellSelectColor] forState:UIControlStateHighlighted];
//    self.backgroundColor = [GlobarMethod colorFromARGB:geek_CellSelectColor];
//    self.layer.borderColor = [[GlobarMethod colorFromARGB:geek_cellDetailTextColor] CGColor];
//    [self setBackgroundImage:[self buttonImageFromColor:[GlobarMethod colorFromARGB:geek_cellDetailTextColor]] forState:UIControlStateHighlighted];
}
