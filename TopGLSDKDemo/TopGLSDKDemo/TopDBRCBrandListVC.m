...
- (void)viewDidLoad {
    ...
    [[TopGLAPIManager shareManager] getDBRCBrandWithMd5:self.mainDeviceInfo.md5 databaseType:self.dataBaseDeviceType complete:^(TopResultInfo * _Nonnull resucltInfo) {
