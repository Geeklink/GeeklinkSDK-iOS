...
- (void)viewDidLoad {
    ...
    [[TopGLAPIManager shareManager] getDBRCBrandFlieIdWithMd5:self.mainDeviceInfo.md5 databaseType:self.dataBaseDeviceType andBrand:self.brand complete:^(TopResultInfo * _Nonnull resucltInfo) {
