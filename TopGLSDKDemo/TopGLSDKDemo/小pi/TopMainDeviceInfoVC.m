...
- (void)refreshTableViewCellWithMainDevStateInfo: (TopMainDevStateInfo *) mainDevStateInfo{
    ...
    if (self.stateInfo.state == GLDevConnectStateOffline) {
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeState)];
    }else {
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeState)];
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeIp)];
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeMac)];
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeCurVer)];
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeLatestVer)];
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeSubDevice)];
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeTime)];
        [self.cellTypeList addObject:@(TopMainDeviceInfoVCCellTypeCode)];
    }
...
- (void)deviceStateChange:(nonnull TopGLAPIResult *)resultInfo {
    ...
    [self refreshTableViewCellWithMainDevStateInfo:resultInfo.mainDevStateInfo];
}
@end
